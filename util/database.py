...
class SQLQuery():
    ...
    @coroutine
    def select(self, table, what='*', where=None, order=None, group=None, limit=None, offset=None, params=None, rowlock=False):
    ...
    @coroutine
    def where(self, table, what='*', order=None, group=None, params=None, rowlock=False, **where):
        
        records = yield self.select(table, what=what, where=where, order=order, group=group, limit=1, params=params, rowlock=rowlock)
